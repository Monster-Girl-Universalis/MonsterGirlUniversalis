...
NGame = {
	...
	RNW_MERC_COMPANY_ARTILLERY_MAX = 0.5, 	-- max artillery_weight if we're using artillery
...
NMilitary = {
	...
	STRELTSY_STARTING_STRENGTH = 1.0,
	...
	STRELTSY_BASE_COST_MODIFIER = 0.75,
	STRELTSY_MANPOWER_COST_MODIFIER = 0.75,
	STRELTSY_STARTING_MORALE = 0.75,
